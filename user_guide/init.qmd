...
-   `permissions` is an i32 representing the octal value of the desired linux file permissions to set for retrieved files. This argument is optional and 777 by default.
