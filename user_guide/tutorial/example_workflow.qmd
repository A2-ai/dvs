...
dvs_init(storage_directory = my_storage_dir)

# optionally, this is the time set the linux file permissions or group if you'd
# this tutorial won't cover this, see the ReadMe if you'd like to check this
```
